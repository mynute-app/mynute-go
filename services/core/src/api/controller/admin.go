...
func CreateAdmin(c *fiber.Ctx) error {
	...
	// Create admin model
	// TODO: This needs to be updated for the new User/Admin architecture
	// 1. First create User in auth service with Email, Password, Type="admin"
	// 2. Then create Admin in core service with UserID reference
	// 3. Then assign roles to the admin
	// For now, this endpoint is disabled until the proper architecture is implemented.
	return lib.Error.General.BadRequest.WithError(fmt.Errorf("admin creation endpoint temporarily disabled - needs update for new User/Admin architecture"))
}
