...
func Test_Company(t *testing.T) {
	...
	}}, company.Owner.X_Auth_Token, nil), "Company update")
	tt.Test(company.GetById(200, company.Owner.X_Auth_Token, nil), "Company get by ID")
	tt.Test(company.GetByName(200, company.Owner.X_Auth_Token, nil), "Company get by name")
	...
	}, company.Owner.X_Auth_Token, nil), "Company upload logo image")
	...
	}, company.Owner.X_Auth_Token, nil), "Company upload additional images")
	tt.Test(company.GetImage(200, company.Created.Design.Images.Logo.URL, &FileBytes.PNG_FILE_1), "Company get logo image")
	...
	tt.Test(company.ChangeColors(200, mJSON.Colors{
		Primary: "#123456",
	}, company.Owner.X_Auth_Token, nil), "Company change colors")
	tt.Test(company.ChangeColors(200, mJSON.Colors{
		Primary:    "#654321",
		Secondary:  "#abcdef",
		Tertiary:   "#fedcba",
	...
	tt.Test(company.DeleteImages(200, []string{
		...
		"favicon",
		"background",
	}, company.Owner.X_Auth_Token, nil), "Company delete images")
	tt.Test(company.ChangeColors(200, mJSON.Colors{}, company.Owner.X_Auth_Token, nil), "Company reset colors")
	tt.Test(company.Delete(200, company.Owner.X_Auth_Token, nil), "Company deletion")
}
