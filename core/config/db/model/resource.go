...
func resources_template() []*Resource {
	...
	UpdateAppointmentByID := &Resource{
		Path:        "/appointment/:id",
	...
	DeleteAppointmentByID := &Resource{
		Path:        "/appointment/:id",
		Method:      "DELETE",
	...
	// --- Auth Resources --- //
	VerifyExistingAccount := &Resource{
	...
	BeginAuthProviderCallback := &Resource{
	...
	GetAuthCallbackFunction := &Resource{
	...
	GetEmployeeServicesByBranchId := &Resource{
	...
	RemoveServiceFromBranch := &Resource{
		Path:        "/branch/:branch_id/service/:service_id",
		Method:      "DELETE",
	...
	RemoveServiceFromEmployee := &Resource{
		Path:        "/employee/:employee_id/service/:service_id",
		Method:      "DELETE",
	...
	RemoveBranchFromEmployee := &Resource{
		Path:        "/employee/:employee_id/branch/:branch_id",
		Method:      "DELETE",
	...
	// --- Combine all resources into the final slice --- //
	return []*Resource{
		// Appointment
		CreateAppointment,
		GetAppointmentByID,
...
func SeedResources(db *gorm.DB) error {
	...
	for _, rsrc := range resources_template() {
