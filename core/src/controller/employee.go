...
//	@Param			X-Company-ID	header	string	true	"X-Company-ID"
//	@Param			email			path	string	true	"Employee Email"
//	@Query			language				query	string	false	"Language for the email content"																											query	string	false	"Language code (default: en)"
//	@Success		200
//	@Failure		400	{object}	DTO.ErrorResponse
...
//	@Produce		json
//	@Param			email		path		string	true	"Employee Email"
//	@Query			language	query				string	false	"Language for the email content"																		string	false	"Language code (default: en)"
