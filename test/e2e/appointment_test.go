...
func Test_Appointment_V2(t *testing.T) {
	...
	GetBranchByID := func(branchID string, company *modelT.Company) (*modelT.Branch, error) {
	...
	GetEmployeeByID := func(employeeID string, company *modelT.Company) (*modelT.Employee, error) {
